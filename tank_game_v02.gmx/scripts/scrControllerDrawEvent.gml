...
switch room
{
    ...
    case roomMain:
    {
        if view_current = 0
        {
            ...
            draw_text(view_xview[0]+5, view_yview[0]+25, "Ammo = "+string(global.ammo_main_gun[PLAYER1]))
        ...
        if view_current = 1
        {
            ...
            draw_text(view_xview[1]+5, view_yview[1]+25, "Ammo = "+string(global.ammo_main_gun[PLAYER2]))
        }
        break ;
    }
}
